...
export function SurfaceState({
  ...
  const defaults: Record<
    Exclude<SurfaceKind, "loading" | "ready">,
  ...
  > = {
    ...
    partial: {
      ...
      description:
        description ?? "What is present is shown below. Missing pieces will fill in when ready.",
    },
    degraded: {
    ...
    failed: {
      ...
      description:
        description ?? "Try again. If it persists, share the correlation ID with support.",
    },
    unauthorized: {
    ...
    offline: {
      ...
      description:
        description ??
        "Pinned reading and the review pack remain available when cached. Other actions need a connection.",
    },
    rate_limited: {
      title: title ?? "Slow down",
      description:
        description ??
        "Too many requests. Wait a moment, then retry. Correlation IDs stay visible for support.",
    },
  };
